function openForm() {       //Function for POP-UP
...
document.addEventListener("click", function(event){
    ...
    if (event.target.matches(".cancel") || !event.target.closest(".form-popup") && !event.target.closest(".open-button") && !event.target.closest(".contact")){
        closeForm()
    }
}, false )
